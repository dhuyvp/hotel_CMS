...
func GetColumnsAndValuesChannelManage(DataStruct models.ChannelManage) (string, string) {
...
func GetQueryUpdateChannelManage(DataStruct models.ChannelManage) string {
	v := reflect.ValueOf(DataStruct)
	typeOfStruct := v.Type()
