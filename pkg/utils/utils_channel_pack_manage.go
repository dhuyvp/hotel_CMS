...
func GetColumnsAndValuesChannelPackManage(DataStruct models.ChannelPackManage) (string, string) {
...
func GetQueryUpdateChannelPackManage(DataStruct models.ChannelPackManage) string {
	v := reflect.ValueOf(DataStruct)
	typeOfStruct := v.Type()
